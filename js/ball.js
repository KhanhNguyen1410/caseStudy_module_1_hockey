class Ball {
    ...
    moveBall1() {
        ...
        if (this.x < backBar.x1+backBar.WBackBar && this.y < backBar.y1+backBar.HBackBar &&
            this.x > backBar.x1-backBar.WBackBar && this.y > backBar.y1-backBar.HBackBar){
            this.Yspeed = -this.Yspeed + 0.5;
        }
        if (this.x < backBar.x2+backBar.WBackBar && this.y < backBar.y2+backBar.HBackBar &&
            this.x > backBar.x2-backBar.WBackBar && this.y > backBar.y2-backBar.HBackBar){
            this.Yspeed = -(this.Yspeed);
        }
